...
export function Sidebar({ className = "" }: { className?: string }) {
  return (
    <aside className={`w-60 bg-black/20 p-6 flex-col gap-8 h-full border-r border-[#222] ${className}`}>
      <div className="flex flex-col gap-4">
        <div className="text-[10px] uppercase tracking-widest text-gray-500 font-bold">Your Library</div>
        <ul className="flex flex-col gap-3">
          <li className="flex items-center gap-3 text-gray-300 hover:text-white cursor-pointer transition">
